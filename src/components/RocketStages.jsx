...
export default function RocketStages({ currentSection }) {
  ...
  useFrame((state, delta) => {
    ...
    // Animate starfield for parallax effect - use time-based animation instead of delta-based
    if (starsRef.current) {
      const time = state.clock.getElapsedTime();
      starsRef.current.rotation.y = time * siteConfig.animations.starRotationSpeed * 0.1;
      starsRef.current.rotation.x = time * siteConfig.animations.starRotationSpeed * 0.05;
    }
